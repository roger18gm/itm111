...
INSERT INTO artist
(artist_id, fname, lname, dob, dod, country, local)
VALUE
(9, 'Milo','Rambaldi', 1444, 1495, 'Italy', 'n');
...
FROM customer
WHERE phone IS NOT NULL AND city = 'Oakland' AND state = 'CA';
...
FROM customer
WHERE (phone IS NOT NULL AND (city LIKE '%ach%' OR city LIKE '%och%')) OR last_name LIKE 'William'
LIMIT 5;
